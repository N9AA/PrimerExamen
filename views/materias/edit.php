...
<div class="container crud-contenido">
    <div class="crud-card">
        <div class="crud-card-header text-center">
            <h1 class="crud-titulo mb-0">Editar materia</h1>
            <p class="subtitulo-crud mb-0 mt-2">
                Modificá los datos de la cursada
            </p>
        </div>
        ...
        <div class="crud-card-body">
            ...
            <form action="index.php?action=update" method="POST" class="crud-form">
                <input
                    type="hidden"
                    name="id"
                    value="<?= htmlspecialchars($materia["id"]) ?>"
                >
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            name="anio_carrera"
                            min="1"
                            value="<?= htmlspecialchars($materia["anio_carrera"]) ?>"
                            required
                        >
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            ...
                            name="anio_cursada"
                            min="2000"
                            value="<?= htmlspecialchars($materia["anio_cursada"]) ?>"
                            required
                        >
                    </div>
                        ...
                        >
                            ...
                            <?php while ($estado = $estados->fetch_assoc()): ?>
                                <option
                                    ...
                                    <?= $materia["id_estado"] == $estado["id_estado"] ? "selected" : "" ?>
                                >
                    ...
                    <div class="col-md-12">
                        ...
                        <input
                            ...
                            min="2000"
                            value="<?= $materia["anio_aprobacion"] !== null
